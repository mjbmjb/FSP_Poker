...
model_args = {'batch_size': arguments.batch_size}
...
def gym_ppo_train():
    ...
    mappo = MAPPO(n_agent=n_agent, env=env, memory_capacity=MEMORY_CAPACITY,
              ...
              done_penalty=DONE_PENALTY, roll_out_n_steps=ROLL_OUT_N_STEPS, max_steps=MAX_STEPS, ppo_epco=PPO_EPCO,
